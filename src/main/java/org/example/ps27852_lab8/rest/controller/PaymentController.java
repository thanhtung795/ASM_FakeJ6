...
import org.example.ps27852_lab8.config.ConfigVnPay;
import org.example.ps27852_lab8.entity.Payment;
...
public class PaymentController {
    ...
    @GetMapping("/vnpay")
    public ResponseEntity<Payment> vnpay(@RequestParam("amount") long amount,@RequestParam("orderId") String orderId) throws UnsupportedEncodingException {
        ...
        Payment responseDTO = Payment.builder()
                .status("success")
